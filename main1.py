...
def main():
    ...
    html_temp4 = """
                        ...
                        <h4 style="color:white;text-align:center;">Developed by Apoorv Gautam using OpenCV,Streamlit,Tensorflow and Keras.</h4>
                        <h4 style="color:white;text-align:center;">Thanks for Visiting</h4>
                        </div>
                        <a href="https://github.com/apoorv1706">Github</a>
                        <a href="https://www.linkedin.com/in/apoorv-gautam/">LinkedIn</a>
                        <br></br>
                        <br></br>"""
